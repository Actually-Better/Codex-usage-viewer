...
function createBackgroundHarness({ tabs = [], snapshot = null, sendError = null, createError = null, forceCreatedTabActive = false, initialState = {}, existingAlarm = true, retainedSignInTabId = null } = {}) {
  const storage = {
